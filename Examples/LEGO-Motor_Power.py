...
try:
    ...
    while True:
        enc_a = BP.get_motor_encoder(BP.PORT_A)
        enc_b = BP.get_motor_encoder(BP.PORT_B)
        enc_c = BP.get_motor_encoder(BP.PORT_C)
        enc_d = BP.get_motor_encoder(BP.PORT_D)
        enc_1 = BP.get_motor_encoder(BP.PORT_1)
        enc_2 = BP.get_motor_encoder(BP.PORT_2)
        enc_3 = BP.get_motor_encoder(BP.PORT_3)
        enc_4 = BP.get_motor_encoder(BP.PORT_4)
        
        print(f'a: {enc_a}, b: {enc_b}, c: {enc_c}, d: {enc_d}, 1: {enc_1}, 2: {enc_2}, 3: {enc_3}, 4: {enc_4}')
